...
const StyledParallax = styled(AppBar, {
...
const CreativeTimParallax: FC<Props> = (
  props
  ...
  const headerColorChange = () => {
    ...
    if (windowsScrollTop > changeColorOnScroll.height) {
      document.body
        ...
        .classList.remove(classes[ct_color])
      document.body
        .getElementsByTagName('header')[0]
        .classList.add(classes[changeColorOnScroll.ct_color])
    } else {
      document.body
        .getElementsByTagName('header')[0]
        .classList.add(classes[ct_color])
      document.body
        .getElementsByTagName('header')[0]
        .classList.remove(classes[changeColorOnScroll.ct_color])
    }
  }
